  ...
  return (
    ...
    >
      <div className="flex w-11/12 max-w-maxContent items-center justify-between">
        ...
        >
          <AiOutlineMenu 
            className={`w-16 h-8 fill-richblack-25 -left-[40px]-bottom-4 `}
            onClick={shownav}
          />
          <div
            ref={overlay}
          ...
          <div ref={show} className="mobNav z-50">
            <nav
              className=" items-center flex flex-col absolute w-[200px] -left-[50px] -top-4  glass2"
              ref={show}
            >
              {token == null && (
                <Link
              ...
              <Link
                ...
                className="p-2"
              >
                <p className=" text-richblack-5 ">Home</p>
              </Link>
              <Link
                to="/about"
                onClick={() => {

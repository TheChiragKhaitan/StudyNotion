...
import convertSecondsToDuration from "../../../../utils/secToDurationFormatter"
...
export default function CoursesTable({ courses, setCourses }) {
  ...
  const handleCourseDelete = async (courseId, studentsEnrolled) => {
    console.log("hey",studentsEnrolled)
    if(studentsEnrolled.length !==0){
      toast.error("Unable to delete the course as students are currently enrolled.");
    }
    else{
      setLoading(true)
    ...
    //To find the length(duration) of each course 
                 ...
                 <button
                    ...
                    onClick={() => {
                      setConfirmationModal({
                        ...
                        btn2Text: "Cancel",
                        btn1Handler: !loading
                          ? () => handleCourseDelete(course._id, course.studentsEnrolled)
                          : () => {},
                        btn2Handler: !loading
                          ? () => setConfirmationModal(null)
                          : () => {},
